...
from app.core.dependencies import get_current_user, get_product_name_service
...
def _validate_cdn_hosts(payload: NameSuggestionRequest, settings: Settings) -> None:
